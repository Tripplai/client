...
const API_BASE = process.env.NEXT_REVIEW_API_URL || 'http://localhost:8080';

// 목록 조회
export async function getReviews({ page = 0, size = 10 }: { page?: number; size?: number } = {}): Promise<ReviewListResponse> {
