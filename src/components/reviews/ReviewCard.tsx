...
export default function ReviewCard({ review }: ReviewCardProps) {
  ...
  // 이미지 로드 실패 시 대체 이미지 사용 (로컬 이미지)
  const getDefaultImage = () => {
    // 로케이션별 로컬 이미지 매핑
    switch (location) {
      case "제주도":
        return "/images/jeju.png";
      case "서울 연남동":
        return "/images/seoul.jpg";
      case "부산 해운대":
        return "/images/busan.png";
      case "경주":
        return "/images/gyeongju.jpg";
      case "전주":
        return "/images/jeonju.jpg";
      case "강원도 양양":
        return "/images/gangwon.jpg";
      default:
        return "/images/reviews-og.jpg";
    }
  };
