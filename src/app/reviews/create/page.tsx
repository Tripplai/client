      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
            ...
            <div className="flex flex-wrap gap-4 mb-4">
              {images.map((img, index) => (
                <div key={index} className="relative w-24 h-24 rounded-md overflow-hidden">
                  <Image src={img} alt={`여행 사진 ${index + 1}`} fill className="object-cover" />
                  <button
                    type="button"
            ...
            <p className="text-sm text-gray-500">여행 장소의 사진을 업로드해주세요. (최대 5장)</p>
          </div>
        </div>
            ...
            <div className="flex items-center justify-center mb-4">
              {receiptImage ? (
                <div className="relative w-full max-w-xs h-48 rounded-md overflow-hidden">
                  <Image src={receiptImage} alt="영수증 또는 입장권" fill className="object-contain" />
                  <button
                    type="button"
