    ...
    spots: [
      {
        id: 's1',
        name: '성산일출봉',
        description: '유네스코 세계자연유산으로 등재된 제주의 대표 명소. 일출 명소로 유명하며, 분화구와 주변 경관이 아름답습니다.',
      ...
      },
      {
        id: 's2',
        name: '우도',
        description: '제주 동쪽에 위치한 작은 섬으로, 아름다운 해변과 경관을 즐길 수 있습니다. 자전거나 전기차를 빌려 섬을 돌아보는 것이 좋습니다.',
      ...
      },
      {
        id: 's4',
        name: '한라산 국립공원',
        description: '제주도의 중심에 있는 한라산은 대한민국에서 가장 높은 산으로, 다양한 등산로를 통해 정상을 오를 수 있습니다.',
      ...
      },
      {
        id: 's6',
        name: '협재해변',
        description: '맑은 에메랄드빛 바다와 백사장이 아름다운 해변으로, 여름철 해수욕과 사계절 풍경 감상이 가능합니다.',
...
const getTimeSlotColor = (timeSlot: '오전' | '오후' | '저녁') => {
  switch (timeSlot) {
    case '오전': return { bg: '#FFB6C1', text: 'black' }; // 밝은 핑크색
    case '오후': return { bg: '#FF69B4', text: 'white' }; // 핫 핑크색
    case '저녁': return { bg: '#DB7093', text: 'white' }; // 진한 핑크색
    default: return { bg: '#FFDEEB', text: 'black' };
  }
};
...
export default function TravelCourseDetail({ params }: { params: { id: string } }) {
        ...
        <Box minH="100vh" py={8} bg="white">
          <Container maxW="container.md">
            <Flex direction="column" align="center" justify="center" py={20}>
              <Heading mb={6} color="gray.700">여행 코스를 찾을 수 없습니다</Heading>
              <Button 
        ...
        <Container maxW={{ base: "95%", md: "container.xl" }} py={6}>
          ...
          <Box textAlign="center" color="gray.700" mb={6} mx="auto" maxW="800px">
            <HStack spacing={3} justify="center" mb={1}>
              ...
              <Text fontSize="sm" color="gray.600">{travelCourse.region}</Text>
            </HStack>
            ...
            <Flex justify="center" align="center" mb={3} wrap="wrap">
              ...
              <Flex align="center">
                ...
                <Text>{travelCourse.rating} ({travelCourse.reviewCount})</Text>
              </Flex>
            </Flex>
          </Box>
                  ...
                  >
                    ...
                    <Box className="detail-overlay">
                      ...
                      <Flex className="address-text">
                        <Image src="/images/popular/map_pin.png" alt="위치" width="22px" height="22px" mr={2} mt="2px" />
                        <Text>{spot.address}</Text>
                      </Flex>
                      
                      <Text className="desc-text">
                        {spot.description.length > 150 
                          ? `${spot.description.substring(0, 140)}...` 
                          : spot.description}
                      </Text>
                    </Box>
                  </Box>
            ...
            >
              ...
              >
                <Box className="price-card-header" bg="#8dd3c7">
                  <Heading size="md" mb={4}>교통 정보</Heading>
                ...
                <Box className="price-card-body">
                  <VStack spacing={5} align="stretch">
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">렌터카</Text>
                        <Text fontSize="sm" color="gray.500">도내 전 지역 자유롭게 이동</Text>
                      </Box>
                    </Box>
                    ...
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">대중교통</Text>
                        <Text fontSize="sm" color="gray.500">버스 + 택시 조합 가능</Text>
                      </Box>
                    </Box>
                    ...
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">왕복 항공권</Text>
                        <Text fontSize="sm" color="gray.500">평균 150,000원/인</Text>
                      </Box>
                    </Box>
                  </VStack>
                </Box>
              ...
              >
                <Box className="price-card-header" bg="#80b1d3">
                  <Heading size="md" mb={4}>예산 정보</Heading>
                  <Box className="price-card-price">
                    <Flex align="center" justify="center">
                      <Image src="/images/popular/cash.png" alt="비용" width="40px" height="40px" mr={3} />
                      <Text>600,000</Text>
                ...
                <Box className="price-card-body">
                  <VStack spacing={5} align="stretch">
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">숙박비</Text>
                        <Text fontSize="sm" color="gray.500">3박 평균 240,000원</Text>
                      </Box>
                    </Box>
                    ...
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">식비</Text>
                        <Text fontSize="sm" color="gray.500">하루 평균 50,000원</Text>
                      </Box>
                    </Box>
                    ...
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">입장료</Text>
                        <Text fontSize="sm" color="gray.500">주요 명소 약 60,000원</Text>
                      </Box>
                    </Box>
                  </VStack>
                </Box>
              ...
              >
                <Box className="price-card-header" bg="#fb8072">
                  <Heading size="md" mb={4}>추천 시기</Heading>
                  <Box className="price-card-price">
                    <Flex align="center" justify="center">
                ...
                <Box className="price-card-body">
                  <VStack spacing={5} align="stretch">
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">최적 날씨</Text>
                        <Text fontSize="sm" color="gray.500">맑은 날씨, 쾌적한 기온</Text>
                      </Box>
                    </Box>
                    ...
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">우천 대비</Text>
                        <Text fontSize="sm" color="gray.500">방수 의류와 우산 준비</Text>
                      </Box>
                    </Box>
                    ...
                    <Box className="price-card-feature">
                      ...
                      <Box>
                        <Text fontWeight="bold" fontSize="sm">방문 기간</Text>
                        <Text fontSize="sm" color="gray.500">최소 3박 4일 권장</Text>
                      </Box>
                    </Box>
                  </VStack>
                </Box>
              ...
              {travelCourse?.tips && travelCourse.tips.length > 0 && (
                ...
                >
                  <Box className="price-card-header" bg="#ffb3c1">
                    <Heading size="md" mb={4}>알아두면 좋은 팁</Heading>
                    <Box className="price-card-price">
                      ...
                      {travelCourse.tips.map((tip, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <Text fontSize="md" lineHeight="1.4">{cleanedTip}</Text>
                          </Flex>
                        );
                      })}
                    </SimpleGrid>
